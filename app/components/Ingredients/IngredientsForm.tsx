...
export default function IngredientsForm({ref, handleSubmit}: IngredientsFormProps) {
  return (
    <form ref={ref} className="flex flex-col xs:flex-row gap-3 max-w-9/10 xs:max-w-3/4 m-auto" onSubmit={handleSubmit}>
        ...
        <Button className="flex-1 xs:basis-[16ch] p-2 text-center font-medium bg-neutral-950 text-neutral-50 dark:bg-neutral-50 dark:text-neutral-950 rounded-md"type="submit">+ Add Ingredient</Button>
    </form>
  );
}